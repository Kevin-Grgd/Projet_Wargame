...
public interface ICarte {
	...
	Heros trouveHeros(Position pos); // Trouve un h�ros choisi al�atoirement parmi les 8 positions adjacentes de pos
	
	boolean deplaceSoldat(Position pos, Soldat soldat);
	void mort(Soldat perso);
	boolean actionHeros(Heros pHeros, Position pos2);
